...
export default class ExpensesForm extends React.Component {
  ...
  selectCreditor = dropDownId => {
    ...
    this.setState({
      creditor: { creditorName: creditorName, creditorId: creditorId }
    });
  };
            ...
            <div className="text-white rgba-stylish-strong py-5 px-5 z-depth-4">
              ...
              <div className="modal-body">
                ...
                >
                  <div className="md-form mb-4">
                    <div className="input-group form-group">
                      ...
                      <input
                        ...
                        value={
                          this.state.creditor !== undefined
                            ? this.state.creditor.creditorName
                            : ""
                        }
                      ...
                      <input
                        ...
                        value={
                          this.state.creditor === undefined
                            ? "Creditor"
                            : this.state.creditor.creditorId
                        }
                      />
                    </div>
                  </div>
                  ...
                  <div id="debtors-group">{debtorFields}</div>
            ...
            >
              ...
              >
                <p className="text-center ">
                  <strong>Warning!</strong> you dont need any more debtors,
                  trust me! ;)
                </p>
              </div>
            </div>
