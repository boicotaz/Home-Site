...
function renderApp() {
  Promise.all([
    grouDetailsAjax.getUsersInGroupDetails(),
    grouDetailsAjax.getGroupDetails(),
    groupMessagesAjax.getGroupMessages(),
    expensesAjax.getExpenseDataAjax(),
    expensesAjax.getExpenseTotalsDataAjax()
  ])
    .then(res => {
      let [
        usersInGroup,
